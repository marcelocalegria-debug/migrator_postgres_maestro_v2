...
-- Mapeadas incorretamente como bytea no PostgreSQL
-- Conversão: bytea → text via convert_from(col, 'LATIN1')
-- ==========================================================
...
-- Cada ALTER roda como statement individual.
...
-- Fim: 362 colunas convertidas de bytea para text